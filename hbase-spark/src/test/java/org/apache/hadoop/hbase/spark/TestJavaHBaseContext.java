...
public class TestJavaHBaseContext implements Serializable {
  ...
  public void testBulkLoad() throws Exception {
    ...
    HBASE_CONTEXT.bulkLoad(rdd, TableName.valueOf(tableName), new BulkLoadFunction(), output.toUri().getPath(),
  ...
  public void testBulkLoadThinRows() throws Exception {
    ...
    HBASE_CONTEXT.bulkLoadThinRows(rdd, TableName.valueOf(tableName), new BulkLoadThinRowsFunction(), output.toString(),
        new HashMap<byte[], FamilyHFileWriteOptions>(), false, HConstants.DEFAULT_MAX_FILE_SIZE);
